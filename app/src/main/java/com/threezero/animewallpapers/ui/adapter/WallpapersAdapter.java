...
public class WallpapersAdapter extends RecyclerView.Adapter<WallpapersAdapter.WallpaperHolder> {
    ...
    private int type = 0;
    public WallpapersAdapter(Context context,List<Integer>mList){
        mContext = context;
        list = mList;
    }

    public WallpapersAdapter(Context context,List<String>mList,boolean net){
        mContext = context;
        list1 = mList;
        type = 1;
    }
    ...
    public WallpaperHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(ResID.getLayoutId("fragment_wallpapers"),parent,false);
...
//        return 1;
    ...
    public class WallpaperHolder extends RecyclerView.ViewHolder {
        ...
        public WallpaperHolder(@NonNull View itemView) {
            super(itemView);
            img = itemView.findViewById(ResID.getId("item_img"));
        }
    }
